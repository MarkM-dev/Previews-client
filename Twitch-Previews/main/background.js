...
let FB_FETCH_INTERVAL_MS = 420000;
...
let options = {
    ...
    sidebarFavorites_show_offline_channels: false,
...
_browser.runtime.onInstalled.addListener(function(details) {
    ...
    if (details.reason === "install") {
        ...
        if (details.reason === "update") {
            ...
            if (details.previousVersion !== "4.7" && details.previousVersion !== "4.8" && details.previousVersion !== "4.9") {
...
_browser.runtime.onMessage.addListener(function(msg, sender, sendResponse) {
    switch(msg.action) {
        ...
        case "bg_update_sidebarFavorites_hide_originals":
            ...
            break;
        case "bg_update_sidebarFavorites_always_updated":
            send_ga_event('sidebarFavorites_au_mode', 'change', msg.detail ? "sBarFavorites_au_ON":"sBarFavorites_au_OFF");
            break;
        case "bg_update_sidebarFavorites_show_offline_channels":
            send_ga_event('sidebarFavorites_of_mode', 'change', msg.detail ? "sBarFavorites_of_ON":"sBarFavorites_of_OFF");
            break;
        ...
        case "bg_favorite_open_in_new_tab":
            _browser.tabs.create({url:'https://www.twitch.tv/' + msg.detail, active: false});
            break;
        ...
        case "bg_open_record_playback_player":
            ...
            break;
        case "bg_record_playback_player_show":
            send_ga_event('recpb_show', 'recpb_show', "recpb_show");
            break;
