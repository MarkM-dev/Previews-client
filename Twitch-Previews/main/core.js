...
function appendScreenShotBtn() {
    ...
    try {
        ...
        if (ttv_fullscreen_btn) {
            ...
            btn_container.innerHTML = '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="100%" width="70%" xmlns="http://www.w3.org/2000/svg"><g>' +
