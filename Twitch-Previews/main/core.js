...
function getUpdateToastBody() {
    return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" >Twitch Previews updated!</div>"
        ...
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- When you hover over the new icon (<img width='17' height='17' src='" + getRuntimeUrl('images/fScrnWithChat_main.png') + "'/>), a small selection menu will appear with the two modes to select.</span>"
        ...
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- Hovering over it will show a small mode selection menu with two buttons: Full Screen with Custom or Default Chat.</span>"
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- The Custom chat will automatically position itself to the right and stretch to screen height.</span>"
