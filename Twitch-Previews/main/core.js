...
function getUpdateToastBody() {
    return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" >Twitch Previews updated!</div>"
        ...
        +  "       <div style=\"font-size: 14px;color: white;margin-top: 20px;\" ><strong >- Sidebar Favorite Channels</strong>"
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- We follow a lot of streamers, but we only have a handful of favorites.</span>"
