...
"                            </div>\n" +
    ...
    function getUpdateToastBody() {
        ...
        return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" ><img style='margin-top: -3px;' src='" + getRuntimeUrl('images/TP24.png') + "' width='24' height='24' />&nbsp;" + _i18n('update_toast_updated_title') + "</div>"
            ...
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;font-weight: bold;\" >- Show/Hide Offline Favorites!</span>"
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >You can now enable a show/hide button to see your offline favorites! (state saved across pages).</span>"
            +  "             <br><div style='height: 8px;' > </div>"
            +  "             <span style=\"font-size: 12px;color: whitesmoke;\" >- Enable in the settings (expand the 'Sidebar Favorite Channels' feature).</span>"
            +  "             <br><div style='height: 8px;' > </div>"
            ...
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;font-weight: bold;\" >- Fixed mature content warning in previews.</span>"
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >You can now hover the preview (for 1 second) and approve the mature content message. if it's too fast, click the volume button and then approve.</span>"
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" ><strong>- Directory Previews:</strong> added clickability & 'go to channel' button.</span>"
            +  "       </div>"
         /*   +  "    </br>"*/
    }
