                        ...
                        if(!isExperimentalSidebar) {
                            ...
                            if (promise_result === 'FOLLOWED_LIST_IS_PARTIAL') {
                                if (section_header_figure) {
                                    section_header_figure.innerHTML = '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="20px" width="20px" xmlns="http://www.w3.org/2000/svg">' +
