...
"                            </div>\n" +
    ...
    function getUpdateToastBody() {
        ...
        return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" ><img style='margin-top: -3px;' src='" + getRuntimeUrl('images/TP24.png') + "' width='24' height='24' />&nbsp;" + _i18n('update_toast_updated_title') + "</div>"
            ...
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;font-weight: bold;\" >- Show Offline Favorites!</span>"
            +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >You can now choose to have your favorites always be shown in the sidebar, even if they are offline!</span>"
