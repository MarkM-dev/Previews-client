        ...
        if (result.tp_cast) {
            ...
            let interval = setInterval(function () {
                if (document.querySelector('.tw-chromecast-button__icon')) {
                    ...
                    appendCastWorker();
                    setTimeout(()=>{
                        overlay.innerHTML = '<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="100px" width="100px" style="position: absolute;margin-top: -250px;margin-right: -400px;" xmlns="http://www.w3.org/2000/svg">' +
...
function getUpdateToastBody() {
    return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" >Twitch Previews updated!</div>"
        ...
        +  "       <div style=\"font-size: 14px;color: white;margin-top: 20px;\" ><strong >- Like in Youtube - Seek Streams Using Keyboard Arrow Keys!</strong>"
