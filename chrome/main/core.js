...
function getUpdateToastBody() {
    return "   <div style=\"font-weight: bold;font-size: 15px;color: white;\" >Twitch Previews updated!</div>"
        ...
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- You can change its transparency & background color, fullscreen, drag, resize and minimize using the buttons at the top.</span>"
        +  "             <br><span style=\"font-size: 12px;color: whitesmoke;\" >- Works well with the \"Full Screen With Chat\" feature.</span>"
        ...
        +  "             <br><br><span style=\"font-size: 12px;\" ><strong>- Added background opacity & color picker controls to the Multi-Chat top bar controls (when toggling transparent mode).</strong></span>"
        +  "             <br><br><span style=\"font-size: 12px;\" ><strong>- Added Always On Top toggle to the Multi-Stream/Chat boxes to support the chat overlay better.</strong></span>"
